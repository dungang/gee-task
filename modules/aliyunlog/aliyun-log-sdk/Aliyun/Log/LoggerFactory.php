...
class Aliyun_Log_LoggerFactory{
    ...
    /**
     * Get logger instance
     * @param mixed $client valid log client
     * @param mixed $project which could be created in AliYun Logger Server configuration page
     * @param mixed $logstore which could be created in AliYun Logger Server configuration page
